...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!isset($data["correspondent_id"], $data["name"], $data["credit"])) {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO others (correspondent_id, name, credit, state) 
                               VALUES (:correspondent_id, :name, :credit, :state)");
